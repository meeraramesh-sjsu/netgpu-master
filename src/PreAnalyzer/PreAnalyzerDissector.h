...
#ifndef PreAnalyzerDissector_h
#define PreAnalyzerDissector_h
...
private:
	...
	//Virtual Actions:
	 ...
	 void Ip4VirtualActionnew(const uint8_t* packetPointer,unsigned int* totalHeaderLength,const struct pcap_pkthdr* hdr,Ip4Header16* header,void* user);
