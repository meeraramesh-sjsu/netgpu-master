...
printf("%d num of patterns",num_strings);
/*	printf("Mining");	
...
template<typename R>
void COMPOUND_NAME(ANALYSIS_NAME,hooks)(PacketBuffer* packetBuffer,R* results, analysisState_t state, int64_t* auxBlocks,int *result,char* pattern,int *index){
	printf("hooks");
