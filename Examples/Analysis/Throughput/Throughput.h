...
/*** General Parameters ***/
#define ANALYSIS_NAME Throughput
#define ANALYSIS_INPUT_TYPE  flowType //int,uint,floats, double(*) intXX_t, uintXX_t, structs etc.. or typedefs (define new types below) 
